...
public abstract class UnaryCRFunction {
     ...
     */
    public static final UnaryCRFunction identityFunction = new UnaryCRFunction() {
        @Override
     ...
     */
    public static final UnaryCRFunction negateFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.negate();
        }
     ...
     */
    public static final UnaryCRFunction inverseFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.inverse();
        }
     ...
     */
    public static final UnaryCRFunction absFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.abs();
        }
     ...
     */
    public static final UnaryCRFunction expFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.exp();
        }
     ...
     */
    public static final UnaryCRFunction cosFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.cos();
        }
     ...
     */
    public static final UnaryCRFunction sinFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.sin();
        }
     ...
     */
    public static final UnaryCRFunction tanFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
     ...
     * -PI/2 and PI/2.
     */
    public static final UnaryCRFunction asinFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.asin();
        }
     ...
     * 0 and PI.
     */
    public static final UnaryCRFunction acosFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.acos();
        }
     ...
     */
    public static final UnaryCRFunction atanFunction = new UnaryCRFunction() {
        private static final CR ONE = CR.valueOf(1);
     ...
     */
    public static final UnaryCRFunction lnFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.ln();
        }
     ...
     */
    public static final UnaryCRFunction sqrtFunction = new UnaryCRFunction() {
        @Override
        public CR execute(CR x) {
            return x.sqrt();
        }
    ...
    private static final class InverseMonotoneUnaryCRFunction extends UnaryCRFunction {
        ...
        final class InverseIncreasingCR extends CR {
            final CR arg;
                ...
                for (int i = 0; ; ++i) {
                    ...
                    // chosen point (guess) in the middle.
                    {
                        ...
                        for (boolean adj_prec = false; ; adj_prec = !adj_prec) {
                            ...
                            outcome = sloppyCompare(f_guess, arg_appr);
                            if (outcome != 0) break;
    ...
    private static final class MonotoneDerivative extends UnaryCRFunction {
        // The following variables are final, so that they
        // can be referenced from the inner class inverseIncreasingCR.
        final UnaryCRFunction[] f = new UnaryCRFunction[1];
        // Monotone increasing.
        ...
        MonotoneDerivative(UnaryCRFunction func, CR l, CR h) {
            f[0] = func;
            low[0] = l;
            high[0] = h;
        ...
        class monotoneDerivativeCR extends CR {
            ...
            monotoneDerivativeCR(CR x) {
                ...
                max_delta_msd = Math.min(max_delta_left_msd, max_delta_right_msd);
            }
